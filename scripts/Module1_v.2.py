...
def genome_preprocessing(species, genome_dir, annotations_dir, output_dir, hisat2_path):
    ...
    if hisat2_path != '':
        ...
        build_index = hisat2_path + "hisat2-build -p " + str(procs) + " -f " + genome_dir + "/" + species + ".fasta " + output_dir + "/" + species + "_annotations"
        ...
        #sp.call(generate_exon, shell=True)
        #print(generate_exon)
        build_index = "hisat2-build -p " + str(procs) + " -f " + genome_dir + "/" + species + ".fasta " + output_dir + "/" + species + "_annotations"
        sp.call(build_index, shell=True)
        #print(build_index)
