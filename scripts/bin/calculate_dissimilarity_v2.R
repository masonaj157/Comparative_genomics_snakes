...
OG_cats<-hash()
for (i in 1:nrow(species1_species2_all_change_kmer_div)){
  OG_cats[species1_species2_all_change_kmer_div$seq[i]]<-species1_species2_all_change_kmer_div$gene_classes[i]
}
...
for (i in 1:nrow(OG_expression)){
  species1_expression_hash[OG_expression$Orthogroup[i]]<-sample1_expression[[1]][i]
}

species2_expression_hash<-hash()
for (i in 1:nrow(OG_expression)){
  species2_expression_hash[OG_expression$Orthogroup[i]]<-sample2_expression[[1]][i]
}
